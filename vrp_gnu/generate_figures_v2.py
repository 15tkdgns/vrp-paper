...
# -------------------------------------------------------------
# Figure 3 v2: Model Performance by Horizon (Pooled R²) — updated data
# -------------------------------------------------------------
def draw_figure_3():
    horizons = [1, 5, 22, 60, 90, 120, 180, 252]
    data = {
        'WEns':      [0.117, 0.625, 0.794, 0.787, 0.767, 0.743, 0.741, 0.701],
        ...
        'XGBoost':   [0.108, 0.612, 0.754, 0.728, 0.704, 0.657, 0.661, 0.647],
        'LightGBM':  [0.111, 0.610, 0.766, 0.748, 0.711, 0.688, 0.677, 0.668],
        'RF':        [0.115, 0.609, 0.786, 0.800, 0.791, 0.773, 0.744, 0.709],
        'BiLSTM-A':  [-0.013, -0.078, -0.202, -0.224, -0.196, -0.130, -0.096, -0.110],
    ...
    plt.tight_layout()
    plt.savefig('figures/Figure_3_v2.png', dpi=300, bbox_inches='tight')
    plt.close()

# -------------------------------------------------------------
# Figure 4 v2: Model Performance Comparison — 22-Day Horizon (updated data)
# -------------------------------------------------------------
def draw_figure_4():
    models = ['WEns', 'Ridge', 'ElasticNet', 'Lasso', 'SVR', 'RF', 'LightGBM', 'XGBoost', 'MLP', 'BiLSTM-A']
    pooled_r2 = [0.794, 0.794, 0.790, 0.789, 0.787, 0.786, 0.766, 0.754, 0.609, -0.202]
    ...
    plt.tight_layout()
    plt.savefig('figures/Figure_4_v2.png', dpi=300, bbox_inches='tight')
    plt.close()
