...
기존 [v50_dual_attention_lstm.py](../src/experiments/creative/v50_dual_attention_lstm.py)에 attention 가중치 반환 기능을 추가했습니다:
...
![자산별 Attention 비교](../src/experiments/verification/v63_asset_comparison.png)
...
![시장 상황별 Attention](../src/experiments/verification/v63_market_regime.png)
...
![Lag 중요도](../src/experiments/verification/v63_lag_importance.png)
...
![성능-Attention 관계](../src/experiments/verification/v63_performance_attention.png)
...
1. **[자산별 비교](../src/experiments/verification/v63_interactive_asset_comparison.html)** - 드롭다운으로 자산 선택
2. **[시계열 Heatmap](../src/experiments/verification/v63_interactive_heatmap.html)** - 500개 샘플의 시간별 패턴
3. **[Lag 중요도](../src/experiments/verification/v63_interactive_lag_importance.html)** - Early vs Recent 비교
4. **[월별 애니메이션](../src/experiments/verification/v63_interactive_monthly.html)** - 시간에 따른 변화
5. **[통합 대시보드](../src/experiments/verification/v63_interactive_dashboard.html)** - 모든 차트 통합
...
![모델 비교](../src/experiments/creative/v64_model_comparison.png)
...
![전체 Feature 중요도](../src/experiments/creative/v64_overall_feature_importance.png)
...
![자산별 Feature 중요도](../src/experiments/creative/v64_feature_importance_by_asset.png)
...
- [v63_attention_analysis.py](../src/experiments/verification/v63_attention_analysis.py) - 기본 attention 분석
- [v63_interactive_dashboard.py](../src/experiments/verification/v63_interactive_dashboard.py) - 인터랙티브 시각화
- [v64_true_dual_attention.py](../src/experiments/creative/v64_true_dual_attention.py) - True Dual Attention 모델
- [v65_robustness_check.py](../src/experiments/verification/v65_robustness_check.py) - 5-seed 강건성 검증
...
![강건성 Box Plot](../src/experiments/verification/v65_robustness_boxplot.png)
...
![Seed별 비교](../src/experiments/verification/v65_seed_comparison.png)
...
![Mean ± Std](../src/experiments/verification/v65_mean_std_comparison.png)
